...
const data = [
  // CodeMaster Academy (service_provider_id: 1) - 4 services
  {
  ...
  // Design Thinkers (service_provider_id: 2) - 3 services
  {
  ...
  // Language Bridge (service_provider_id: 3) - 3 services
  {
  ...
  // Business Analytics Pro (service_provider_id: 4) - 2 services
  {
  ...
  // Young Scientists Club (service_provider_id: 5) - 3 services
  {
  ...
  // Culinary Arts Institute (service_provider_id: 6) - 2 services
  {
