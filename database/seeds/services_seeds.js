...
const data = [
  // CodeMaster Academy (ProviderId: 1) - 4 services
  {
  ...
  // Design Thinkers (ProviderId: 2) - 3 services
  {
  ...
  // Language Bridge (ProviderId: 3) - 3 services
  {
  ...
  // Business Analytics Pro (ProviderId: 4) - 2 services
  {
  ...
  // Young Scientists Club (ProviderId: 5) - 3 services
  {
  ...
  // Culinary Arts Institute (ProviderId: 6) - 2 services
  {
